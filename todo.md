...
## إصلاح نظام تثبيت PWA - الدورة الثانية ✅ مكتمل
- [x] إصلاح اختفاء الزر بعد إلغاء التثبيت (canInstall لا يتأثر بإلغاء المستخدم)
- [x] إظهار نص "تثبيت التطبيق" دائماً بجانب الأيقونة في الزر العائم
- [x] تحويل البانر ليظهر في وسط الشاشة (modal overlay)
- [x] حذف "يعمل بدون اتصال" من مزايا البانر
...
## مشكلة عدم وصول رسائل WhatsApp إلا عند فتح الصفحة

- [ ] فحص الكود الحالي وتحديد سبب المشكلة (polling vs webhooks)
- [ ] تحليل نظام webhooks الحالي
