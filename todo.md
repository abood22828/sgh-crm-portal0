...
#### 3. تعديل تبويب العملاء المسجلين
- [ ] دمج جميع العملاء (مخيمات + عروض + مواعيد) في تبويب واحد
- [ ] إضافة عمود "النوع" (موعد طبيب / عرض / مخيم)
- [ ] إضافة فلترة حسب النوع

#### 4. إضافة فلترة متقدمة
- [ ] إضافة فلترة بالطبيب في مواعيد الأطباء
- [ ] إضافة فلترة بالتاريخ في تبويب العملاء
- [ ] إضافة فلترة بالتاريخ في حجوزات العروض
- [ ] إضافة فلترة بالتاريخ في تسجيلات المخيمات
- [ ] إضافة فلترة بالتاريخ في مواعيد الأطباء

#### 5. تخصيص PWA للوحة التحكم
- [ ] تخصيص PWA لتظهر فقط في لوحة التحكم
- [ ] استبدال أيقونة PWA بشعار المنصة الحقيقي
- [ ] تحديث manifest.json بالشعار الجديد

#### 6. Offline Experience متقدمة
- [ ] إنشاء صفحة offline مخصصة
- [ ] عرض المواعيد المحفوظة محلياً
- [ ] إضافة إمكانية حفظ الحجوزات offline
- [ ] تطبيق background sync للإرسال عند عودة الاتصال
